...
const QUERIES = [
  ["safety", "storm clouds over prairie dramatic sky"],
  ["safety", "gulf coast storm clouds gathering"],
  ["safety", "dog drinking water bowl outdoors summer"],
  ["safety", "dog resting in shade under tree summer"],
  ["safety", "veterinary technician examining dog gently"],
  ["safety", "clean bright corridor natural light interior"],
  ["safety", "mopping cleaning floor bucket"],
  ["safety", "golden retriever lying on clean floor sunlight"],
];

    ...
    <div className="min-h-screen bg-paper">
      ...
      <header className="border-b border-ink/15 bg-paper">
        <div className="gutter flex flex-wrap items-center justify-between gap-4 py-5">
          ...
          <a
            href="/"
            className="group flex items-center gap-2.5 font-sans text-[0.72rem] font-bold uppercase tracking-[0.18em] text-ink/80 transition-colors hover:text-flame"
          >
      ...
      <div className="gutter pb-10 pt-16 md:pb-14 md:pt-24">
        <p className="label text-flame">Guest Policies</p>
        <h1 className="mt-5 d-1 max-w-[15ch] font-serif text-ink">
          Their health <span className="italic text-flame">and safety</span> first.
        </h1>
      ...
      <div className="gutter grid grid-cols-1 gap-x-14 gap-y-12 pb-24 md:grid-cols-[16rem_1fr] md:pb-32">
        ...
        <nav aria-label="Contents" className="md:sticky md:top-10 md:self-start">
          ...
          <ul className="mt-4 space-y-2.5">
            {guidelineSections.map((s, i) => (
              <li key={s.title} className="flex gap-3">
                <span className="font-sans text-[0.7rem] tabular-nums text-flame">
          ...
          {guidelineSections.map((s, i) => (
            ...
            >
              <div className="flex items-baseline gap-4">
                <span className="font-sans text-[0.75rem] tabular-nums text-flame">
                  {String(i + 1).padStart(2, '0')}
                </span>
